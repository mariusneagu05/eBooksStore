<%-- 
    Document   : eBooksStoreAdminUserPage
                ...
                <c:when test="${validUser == true}">   
                    ...
                    <%-- Master view --%>
                        ...
                        <sql:query dataSource="${snapshot}" var="result">
                            SELECT USERS.ID, USERS.NAME, USERS.USERNAME, USERS.PASSWORD, USER_ROLES.ROLE FROM USERS, USER_ROLES WHERE USERS.ID_ROLE = USER_ROLES.ROLE ORDER BY USERNAME, ROLE ASC 
                        </sql:query>
                        ...
                        <sql:query dataSource="${snapshotroles}" var="resultroles">
                            SELECT ROLE from USER_ROLES ORDER BY ROLE ASC 
                        </sql:query>
