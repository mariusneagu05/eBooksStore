<%-- 
    Document   : eBooksStoreSoldBooks
    Created on : Jun 25, 2017, 2:00:15 PM
    Author     : MariusNeagu
--%>
            ...
            <c:when test="${validUser == true}">  
                ...
                <form action="${pageContext.request.contextPath}/eBooksStoreSoldBooksServlet" method="POST">
                    ...
                    <sql:query dataSource="${snapshot}" var="result">
                        SELECT SOLD_EBOOKS.USER_ID, SOLD_EBOOKS.USERNAME, SOLD_EBOOKS.ISBN,  SOLD_EBOOKS.TITLE, SOLD_EBOOKS.AUTHOR, SOLD_EBOOKS.BOUGHT_DATE FROM SOLD_EBOOKS, EBOOKS, USERS WHERE SOLD_EBOOKS.USER_ID = USERS.ID AND SOLD_EBOOKS.ISBN = EBOOKS.ISBN ORDER BY USER_ID ASC
                    </sql:query>
